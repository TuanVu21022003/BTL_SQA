...
describe('DashboardController.getRevenueByCategory() method', () => {
  ...
  describe('Happy paths', () => {
    /**
     * Test case: TC_DASHBOARD_REVENUE_CATEGORY_001
     ...
     * Expected Output: Đối tượng response thành công với dữ liệu doanh thu theo danh mục
     * Ghi chú: Kiểm tra luồng thành công với bộ lọc theo tuần
     */
    it('TC_DASHBOARD_REVENUE_CATEGORY_001 - Nên trả về doanh thu theo danh mục với bộ lọc "Tuần"', async () => {
      // Sắp xếp (Arrange)
      const mockResult = [
    ...
    /**
     * Test case: TC_DASHBOARD_REVENUE_CATEGORY_002
     ...
     */
    it('TC_DASHBOARD_REVENUE_CATEGORY_002 - Nên trả về doanh thu theo danh mục với bộ lọc "Tháng"', async () => {
      // Sắp xếp (Arrange)
      const mockResult = [
  ...
  describe('Edge cases', () => {
    /**
     * Test case: TC_DASHBOARD_REVENUE_CATEGORY_003
     ...
     */
    it('TC_DASHBOARD_REVENUE_CATEGORY_003 - Nên xử lý lỗi từ service một cách hợp lý', async () => {
      // Sắp xếp (Arrange)
    ...
    /**
     * Test case: TC_DASHBOARD_REVENUE_CATEGORY_004
     ...
     */
    it('TC_DASHBOARD_REVENUE_CATEGORY_004 - Nên xử lý ngoại lệ không phải kiểu Error', async () => {
      // Sắp xếp (Arrange)
