...
describe('DashboardController.getLateProduct() method', () => {
  ...
  describe('Happy paths', () => {
    /**
     * Test case: TC_DASHBOARD_LATEST_PRODUCT_001
     * Mục tiêu: Kiểm tra phương thức getLateProduct trả về kết quả thành công
     * Input: Không có tham số đầu vào
     * Expected Output: Đối tượng response thành công với danh sách sản phẩm mới nhất
     * Ghi chú: Kiểm tra luồng thành công cơ bản
     */
    it('TC_DASHBOARD_LATEST_PRODUCT_001 - Nên trả về danh sách sản phẩm mới nhất', async () => {
      // Sắp xếp (Arrange)
      const mockResult = [
    ...
    /**
     * Test case: TC_DASHBOARD_LATEST_PRODUCT_002
     ...
     */
    it('TC_DASHBOARD_LATEST_PRODUCT_002 - Nên trả về danh sách rỗng khi không có sản phẩm mới', async () => {
      // Sắp xếp (Arrange)
      const mockResult = [];
      mockDashboardService.getLatestProduct.mockResolvedValue(mockResult as any as never);
  ...
  describe('Edge cases', () => {
    /**
     * Test case: TC_DASHBOARD_LATEST_PRODUCT_003
     ...
     */
    it('TC_DASHBOARD_LATEST_PRODUCT_003 - Nên xử lý lỗi từ service một cách hợp lý', async () => {
      // Sắp xếp (Arrange)
    ...
    /**
     * Test case: TC_DASHBOARD_LATEST_PRODUCT_004
     ...
     */
    it('TC_DASHBOARD_LATEST_PRODUCT_004 - Nên xử lý ngoại lệ không phải kiểu Error', async () => {
      // Sắp xếp (Arrange)
