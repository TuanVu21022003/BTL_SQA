...
describe('DashboardController.getTopProducts() method', () => {
  ...
  describe('Happy paths', () => {
    /**
     * Test case: TC_DASHBOARD_TOP_PRODUCTS_001
     ...
     * Expected Output: Đối tượng response thành công với danh sách sản phẩm bán chạy
     * Ghi chú: Kiểm tra luồng thành công với bộ lọc theo tuần
     */
    it('TC_DASHBOARD_TOP_PRODUCTS_001 - Nên trả về danh sách sản phẩm bán chạy với bộ lọc "Tuần"', async () => {
      // Sắp xếp (Arrange)
      const mockResult = [
    ...
    /**
     * Test case: TC_DASHBOARD_TOP_PRODUCTS_002
     ...
     */
    it('TC_DASHBOARD_TOP_PRODUCTS_002 - Nên trả về danh sách sản phẩm bán chạy với bộ lọc "Tháng"', async () => {
      // Sắp xếp (Arrange)
      const mockResult = [
  ...
  describe('Edge cases', () => {
    /**
     * Test case: TC_DASHBOARD_TOP_PRODUCTS_003
     ...
     */
    it('TC_DASHBOARD_TOP_PRODUCTS_003 - Nên xử lý lỗi từ service một cách hợp lý', async () => {
      // Sắp xếp (Arrange)
    ...
    /**
     * Test case: TC_DASHBOARD_TOP_PRODUCTS_004
     ...
     */
    it('TC_DASHBOARD_TOP_PRODUCTS_004 - Nên xử lý ngoại lệ không phải kiểu Error', async () => {
      // Sắp xếp (Arrange)
